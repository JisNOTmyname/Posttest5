...
if (isset($_POST["tambah"])) {
    ...
    $result = mysqli_query($conn, "insert into mobil 
    (ID, Email, Phone, Gender, Address, BRAND, COLOR, MODEL, YEAR, Birth) 
    values ('', '$email', '$phone', '$Gender', '$Address', '$BRAND','$color','$model', '$year', '$birth')");
